...
describe("EmailService", () => {
  ...
  describe("sendAssignmentEmail", () => {
    ...
    it("should send email in mock mode (no credentials)", async () => {
      ...
      const result = await emailService.sendAssignmentEmail(
        mockAssignmentEmail
      );
  ...
  describe("edge cases and integration", () => {
    ...
    it("should handle very long names and session names", async () => {
      ...
      const longEmail: AssignmentEmail = {
        participantName:
          "Very Long Participant Name That Might Cause Issues In Some Systems",
        participantEmail: "verylongname@example.com",
        sessionName:
          "Very Long Session Name That Should Still Work Fine Without Any Problems",
